const DeleteConfirmModal = ({ isOpen, onClose, onConfirm, milestoneTitle, isDeleting }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 animate-slide-up">
        <div className="p-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <p className="text-base font-medium text-gray-900 break-words">"{milestoneTitle}"</p>
          </div>
